...
export const ghostAPIUrl = process.env.CMS_GHOST_API_URL || 'https://content.brian.dev'
export const ghostAPIKey = process.env.CMS_GHOST_API_KEY || 'd530b63612972c36c8f324d61f'
