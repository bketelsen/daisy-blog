...
![Remote Desktop](/src/assets/static/images/wsl/rdp.png)
...
![Network Level Auth](/src/assets/static/images/wsl/nla.png)
...
![Firewall Settings](/src/assets/static/images/wsl/firewall.png)

Then open the Advanced Firewall settings:

![Advanced Firewall Settings](/src/assets/static/images/wsl/advancefw.png)

Click "Inbound" in the left pane, then "New..." on the right pane. Choose "Port":

![Port](/src/assets/static/images/wsl/port.png)

Then specify port 2222:

![Port 2222](/src/assets/static/images/wsl/port2222.png)

Specify "Allow"

![Allow](/src/assets/static/images/wsl/allow.png)
