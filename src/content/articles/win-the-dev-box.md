...
![Rename PC](/src/assets/static/images/wsl/renamepc.jpg)
...
![Insider](/src/assets/static/images/wsl/insider.png)
...
![Elevated Access Powershell](/src/assets/static/images/wsl/wsl-powershell-admin.png)
...
![Ubuntu](/src/assets/static/images/wsl/microsoft-store-ubuntu.png)
...
![Windows Terminal](/src/assets/static/images/wsl/windows-terminal.png)

- Open the `Ubuntu` app from your Start menu

![ubuntu](/src/assets/static/images/wsl/wsl-first-run.png)
...
![success](/src/assets/static/images/wsl/wsl-success.png)
...
![pin](/src/assets/static/images/wsl/pintostart.png)
...
![remote](/src/assets/static/images/wsl/vscode-remote-extensionpack.png)
...
![default](/src/assets/static/images/wsl/terminal-default-profile.png)
...
![Windows Explorer](/src/assets/static/images/wsl/explorer-integration.png)
...
![Docker from Both Sides](/src/assets/static/images/docker-two-sides.png)
